...
create table item (item_id bigint not null auto_increment, description text, discount double precision, image_url varchar(255), name varchar(255), price double precision, qty bigint, unit_of_measure varchar(255) not null, item_category_id bigint, item_level_id bigint, primary key (item_id)) engine=InnoDB;
create table item_category (item_category_id bigint not null auto_increment, item_category_description varchar(255), item_category_name varchar(255), primary key (item_category_id)) engine=InnoDB;
...
create table shopping_cart (shopping_cart_id bigint not null auto_increment, total_amount double precision, primary key (shopping_cart_id)) engine=InnoDB;
...
create table user (user_id bigint not null auto_increment, first_name varchar(255), last_name varchar(255), dob date, email varchar(255), enabled bit, password varchar(255), phone_number varchar(255), total_spent double precision, username varchar(255), address_id bigint, role_id bigint not null, shopping_cart_id bigint, token_id bigint, primary key (user_id)) engine=InnoDB;
...
alter table item_category add constraint UK_9euth6jjr0gpukv5rjrbhkm28 unique (item_category_name);
...
alter table user add constraint FK47sl5t5w02wtg9lg2f6iqopnn foreign key (shopping_cart_id) references shopping_cart (shopping_cart_id);
...
create table shopping_cart_item (shopping_cart_item_id bigint not null auto_increment, ordered_qty bigint, total_item_price double precision, item_id bigint, shopping_cart_id bigint, primary key (shopping_cart_item_id)) engine=InnoDB
create table token (token_id bigint not null auto_increment, created bigint, expiration bigint, token varchar(255), primary key (token_id)) engine=InnoDB
create table user (user_id bigint not null auto_increment, first_name varchar(255), last_name varchar(255), dob date, email varchar(255), enabled bit not null, password varchar(255), phone_number varchar(255), total_spent double precision, username varchar(255), address_id bigint, role_id bigint not null, shopping_cart_id bigint, token_id bigint, primary key (user_id)) engine=InnoDB
alter table city add constraint UK_djnk44fptegbsu6drhc9xvlfj unique (city_name)
alter table country add constraint UK_qrkn270121aljmucrdbnmd35p unique (country_name)
alter table item_category add constraint UK_9euth6jjr0gpukv5rjrbhkm28 unique (item_category_name)
alter table _order add constraint FKbflijfsx3uwbvdfmkrr2qnmf2 foreign key (order_number_generator_id) references order_number_generator (order_number)
...
create table shopping_cart_item (shopping_cart_item_id bigint not null auto_increment, ordered_qty bigint, total_item_price double precision, item_id bigint, shopping_cart_id bigint, primary key (shopping_cart_item_id)) engine=InnoDB
create table token (token_id bigint not null auto_increment, created bigint, expiration bigint, token varchar(255), primary key (token_id)) engine=InnoDB
create table user (user_id bigint not null auto_increment, first_name varchar(255), last_name varchar(255), dob date, email varchar(255), password varchar(255), phone_number varchar(255), total_spent double precision, username varchar(255), address_id bigint, role_id bigint not null, shopping_cart_id bigint, token_id bigint, primary key (user_id)) engine=InnoDB
alter table city add constraint UK_djnk44fptegbsu6drhc9xvlfj unique (city_name)
alter table country add constraint UK_qrkn270121aljmucrdbnmd35p unique (country_name)
alter table item_category add constraint UK_9euth6jjr0gpukv5rjrbhkm28 unique (item_category_name)
alter table _order add constraint FKbflijfsx3uwbvdfmkrr2qnmf2 foreign key (order_number_generator_id) references order_number_generator (order_number)
